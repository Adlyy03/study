<aside class="hidden w-64 bg-gray-800 md:block min-h-screen">
  ...
  <nav class="text-sm text-gray-300">
    <ul class="flex flex-col">
      <li class="px-4 cursor-pointer bg-gray-500 text-gray-800 hover:bg-gray-700  hover:text-white">
        <a class="py-3 flex items-center" href="{{ route('dashboard') }}">
      ...
      <li class="px-4 cursor-pointer hover:bg-gray-700">
        <a href="{{ route('students.index') }}"
          class="py-3 flex items-center" href="/">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-4 mr-3">
            <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <li class="px-4 cursor-pointer hover:bg-gray-700">
        <a class="py-3 flex items-center" href="{{ route('users.index') }}">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-4 mr-3">
            <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <li class="px-4 py-2 text-xs uppercase tracking-wider text-gray-500 font-bold">PRODUCT MANAGEMENT</li>
      <li class="px-4 cursor-pointer hover:bg-gray-700">
        <a class="py-3 flex items-center" href="/">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-4 mr-3">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m0 0 .5 1.5m-.5-1.5h-9.5m0 0-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />
      ...
      <li class="px-4 cursor-pointer hover:bg-gray-700">
      <a href="{{ route('profile.edit') }}" class="py-2 flex items-center">
    <!-- Icon Profile -->
      ...
      <li class="px-4 cursor-pointer hover:bg-gray-700">
        <a href="{{ route('logout') }}" 
          ...
          class="py-2 flex items-center text-red-400 hover:text-red-300">
          <!-- Icon Logout -->
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
              stroke-width="1.5" stroke="currentColor" class="w-4 mr-3">
            <path stroke-linecap="round" stroke-linejoin="round" 
