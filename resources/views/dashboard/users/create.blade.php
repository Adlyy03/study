    ...
    <div class="py-6 max-w-lg mx-auto">
        <form action="{{ route('users.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="role" value="{{ old('role') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
